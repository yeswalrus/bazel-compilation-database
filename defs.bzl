...
_compilation_database = rule(
    attrs = {
        ...
        "generate_header_output_group": attr.bool(
            default = False,
            doc = "Set an output group containing all headers. Will cause any rule required to generate a discovered header to run"
        ),
